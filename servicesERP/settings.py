"""
Django settings for servicesERP project.
...
SECRET_KEY = 'django-insecure-3wl9w-@p6a!)$$0=#_(&24a3yfckrq(4vpq-hfwy*@*(itp!5*'
...
WSGI_APPLICATION = 'servicesERP.wsgi.application'
